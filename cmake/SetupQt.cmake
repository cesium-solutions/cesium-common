...
if ( WIN32 )
  ...
  if ( NOT ENV{QTDIR} AND NOT QTDIR )
    if ( EXTERN_DIR )
      set( ENV{QTDIR} ${EXTERN_DIR}/qt-everywhere-opensource-src-${QT_VERSION} )
      set( QTDIR ${EXTERN_DIR}/qt-everywhere-opensource-src-${QT_VERSION} )
      set( QT_QMAKE_EXECUTABLE ${QTDIR}/bin/qmake )
    else()
      message( FATAL_ERROR "Neither QTDIR nor EXTERN_DIR are set, set one of these appropriately." )
      return()
    endif()
  endif()
